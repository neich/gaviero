...
TUI implements `WriteGateObserver`, `AcpObserver`, `SwarmObserver` (from gaviero-core). Each holds event channel sender — core callbacks become `Event` variants processed in main loop.
