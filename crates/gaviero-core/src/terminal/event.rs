...
pub enum TerminalEvent {
    ...
    PtyOutput { id: TerminalId, data: Vec<u8> },
    ...
    ShellStateChanged { id: TerminalId, state: ShellState },
    /// Working directory changed (driven by OSC 7).
    CwdChanged { id: TerminalId, cwd: PathBuf },
    /// A command started executing (OSC 133;C).
    CommandStarted { id: TerminalId, command: String },
