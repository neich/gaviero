...
- Embedder is pluggable (`Embedder` trait + `model_manager::resolve_embedder_model`); default `nomic-embed-text-v1.5` (768-dim, `memory.embedder.model = "nomic"`). Cosine similarity.
